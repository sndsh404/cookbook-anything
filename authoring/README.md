...
| `numbers.py` | pulls only the load-bearing numbers/specs from your draft into a checklist | fix what the in-session check flags |
...
5. `numbers.py` pulls the load-bearing numbers; the in-session check flags any
